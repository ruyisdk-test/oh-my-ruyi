...
from oh_my_ruyi.gui.about_tab import AboutTab, application_version, telemetry_summary
...
def test_about_tab_shows_two_version_panels(qtbot, tmp_path: Path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "oh_my_ruyi.gui.about_tab.version_manager.read_path_state",
...
def test_telemetry_form_expands_left_aligned_without_wrapping(
    ...
    monkeypatch.setattr(
        "oh_my_ruyi.gui.about_tab.telemetry_summary",
        lambda _config: (
            "On",
