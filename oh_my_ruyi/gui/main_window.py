...
from ..services import host_storage, repo_manager, ruyi_facade, version_manager
from . import first_use
from .about_tab import AboutTab
from .first_use import FirstUseDialog
from ..runtime.i18n import _, translate_widget_tree
from ..runtime.qt_logger import LogEmitter, QtRuyiLogger
from .repo_manager_tab import RepoManagementTab
from ..runtime.rich_output import RichTextView, rich_to_html, strip_terminal_controls
...
from ..runtime.worker_runtime import stop_thread
...
class ProvisionMainWindow(QMainWindow):
    ...
    def _apply_styles(self) -> None:
        ...
        try:
            self.setStyleSheet(stylesheet_for_colors(colors))
        finally:
            self._applying_styles = False
