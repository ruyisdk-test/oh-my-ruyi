"""Palette-derived colors and stylesheet generation for the main window."""
...
def theme_colors(palette: QPalette) -> dict[str, str]:
    """Return semantic colors for the current application palette."""
...
def stylesheet_for_colors(colors: dict[str, str]) -> str:
    """Build the shared application stylesheet from semantic colors."""
    return f"""
...
__all__ = ["stylesheet_for_colors", "theme_colors"]
